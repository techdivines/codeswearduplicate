      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form onSubmit={handleSubmit} class="space-y-6" method="POST">
          <div>
            ...
            <div class="mt-2">
              <input value={name} onChange={handleChange} id="name" name="name" type="text" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-600 sm:text-sm sm:leading-6" />
            </div>
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
          Not a member?
          <Link href="/login"><span class="font-semibold leading-6 text-pink-600 hover:text-pink-500"> Signin to CodesWear</span></Link>
        </p>
      </div>
    </div>
  )
