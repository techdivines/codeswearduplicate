...
const Checkout = ({ cart, addToCart, removeFromCart, subTotal }) => {
  ...
  return (
    <div className='container m-auto'>
      ...
      <h2 className='font-semibold text-xl m-2'>2. Review Cart Items</h2>
      ...
      <div className="m-2">
        <Link href={'/checkout'}><button  onClick={initiatePayment} class="flex mr-2 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-600 rounded text-sm">Pay $ {subTotal} </button></Link>
