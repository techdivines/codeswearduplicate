  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">Order ID: #649587</h1>
        <div class="flex mb-4">
          <a class="flex-grow text-pink-500 border-b-2 py-2 text-lg px-1">Item Description</a>
        ...
        <div class="flex border-t border-gray-200 py-2">
          <span class="text-gray-500">Wear the code - Tshirt</span>
          <span class="ml-auto text-gray-900">1</span>
          <span class="ml-auto text-gray-900">79</span>

        </div>
        <div class="flex border-t border-gray-200 py-2">
          <span class="text-gray-500">Wear the code - Mug</span>
          <span class="ml-auto text-gray-900">1</span>
          <span class="ml-auto text-gray-900">79</span>

        </div>
        <div class="flex border-t border-b mb-6 border-gray-200 py-2">
          <span class="text-gray-500">Wear the code - Hoodie</span>
          <span class="ml-auto text-gray-900">1</span>
          <span class="ml-auto text-gray-900">79</span>
